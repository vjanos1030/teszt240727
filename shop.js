const shopData = [
  ...
  function render(products) {
    ...
    products.forEach((product) => {
      ...
      productDetails.appendChild(productList);
  ...
  function drawCategories(categories) {
    ...
    categoryContainer.className = "categories-container";
  ...
  function drawFilteredCategories(categories) {
    const categoryContainer = document.createElement("div");
    categoryContainer.className = "categories-container";
    ...
    categories.forEach((category) => {
      ...
      button.addEventListener("click", () => {
        if (button.classList.contains("active")) {
          ...
          const filteredProducts = shopData.filter(product => product.category === category);
 ...
 const categorie = getUniqueCategories(shopData);
  drawFilteredCategories(categories);
  ...
  async function renderFromAPI() {
      try {
          ...
          if (!response.ok) {
              throw new Error(`Nem sikerült a lekérdwzés`);
          }
